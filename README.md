...
<img src='https://skillicons.dev/icons?i=html,css,tailwind,bootstrap,react,next,nodejs,ts,js,postgres,mysql,java,git,firebase,mongodb,postman,gcp,express' alt="icon" />
